	...
	<div id="wrapper">
		<div class="top_planet">
			...
			<div id="content">
				...
				{include file="design/sub_menu.tpl" root_url="{$root_url}" current="{$current_sub_menu}"}
								
				{include file="design/design_portfolio_work_description.tpl" module="{$module}"}
				
				{include file="design/design_portfolio_work_pictures.tpl" module="{$module}"}
				
				{include file="design/design_portfolio_work_teasers.tpl" root_url="{$root_url}" module="{$module}"}				
