				...
				<table width="100%">
					<tr>
						...
						<td class="helpMenu">
							...
							<?php echo JHTML::_('link', 'http://docs.joomla.org/index.php?title=SunNY.credits.15&printable=true', JText::_( 'Credits' ), array('target' => 'helpFrame')) ?> |
							<?php echo JHTML::_('link', 'http://docs.joomla.org/index.php?title=SunNY.support.15&printable=true', JText::_( 'Support' ), array('target' => 'helpFrame')) ?>
							<?php } ?>
							|
							...
							|
							<?php echo JHTML::_('link', 'http://docs.joomla.org/index.php?title=SunNY_1.5_version_history&printable=true', JText::_( 'Latest Version Check' ), array('target' => 'helpFrame')) ?>
						</td>
					</tr>
				</table>
			</td>
