...
class ServicesViewLibrary extends JView{
	function display($tpl = null){
		...
		$lists['order']	     = $mainframe->getUserStateFromRequest( "com_services.library.filter_order",     'filter_order',     'c.ordering', 'cmd' );
		$lists['order_Dir']	 = $mainframe->getUserStateFromRequest( "com_services.library.order_Dir", 'filter_order_Dir', 'ASC',        'word' );			
