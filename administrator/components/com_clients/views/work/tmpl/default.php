	...
	<table class="adminlist">
		<thead>
			<tr>
                ...
                <th width="250"><?php echo JText::_('Клиент')?></th> 
                <th width="200"><?php echo JText::_('Категория')?></th> 
                <th width="80">
		...
		<tbody>
			<?php 
				foreach($this->items as $item):
						...
						$clientName = $model->getClientName($info->id_client);
						$catTitle   = $model->getCatName($info->id_category);
					...
					<tr class="row<?php echo ($i%2) ? 0 : 1;?>">
						...
						<td align="center"><?php echo $clientName?></td>
						<td align="center"><?php echo $catTitle?></td>
