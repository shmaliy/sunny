<?php
	...
	$i=0;
?>
<form action="index.php?option=<?php echo $option?>&view=client" method="post" name="adminForm">
<div id="editcell">
	<table class="adminlist">
		<thead>
			<tr>
                ...
                <th width="150"><?php echo JText::_('Сслка')?></th>
                <th width="150"><?php echo JText::_('Лого')?></th>  
                <th width="80">
			...
			<?php 
				foreach($this->items as $item):
					...
					<tr class="row<?php echo ($i%2) ? 0 : 1;?>">
						...
						<td align="center"><img src="../images/sunny/client/<?php echo $item->logo ?>?w=100&tc&ns" /></td>
