...
?>
				...
				if ($row->published == 1) {
?>
							<img src="templates/sunny/images/menu/icon-16-default.png" alt="<?php echo JText::_( 'Published' ); ?>" />
								<?php
...
?>
				...
				if ($row->published == 1) {
?>
								<img src="templates/sunny/images/menu/icon-16-default.png" alt="<?php echo JText::_( 'Default' ); ?>" />
								<?php
