...
* @subpackage Clients
*/
class ConsultingControllerServices extends ConsultingController{
	/**
	* @var string $view вид
	*/	
	var $view      = 'services';
	...
	*/
	...
	function __construct(){
		...
		$this->model = $this->getModel('Services');
	}
	/**
	...
	*/	
	function save(){
		...
		if( !$id ):
			$this->model->_save($id_consultant, $title, $desc, $published);
			$this->setRedirect("index.php?option={$this->component}&view={$this->view}", JText::_('Изменения сохранены'));
		else:
			$this->model->_update($id, $id_consultant, $title, $desc, $published);
			$this->setRedirect("index.php?option={$this->component}&view={$this->view}", JText::_('Изменения сохранены'));
		endif;
