	...
	<div class="fixed">
		<div class="footer_left">
			...
			<div class="contact_full_left">
				...
				<div><a href="callto:+380676798999" style="text-decoration:none;"><?php echo $tel?></a></div>
				<div><a href="callto:+380562680111" style="text-decoration:none;">+38 0 (562) 680 111 (<?php echo JText::_('CONTACT_FAX')?>)</a></div>
			</div>
			<div class="contact_full_left">
			...
			<div class="contact_full_left">
				...
				<div>Skype: <a href="callto:sunny.creative"><?php echo $skype?></a></div>
			</div>
			<div class="clearer"></div>
			<div class="contact_full_left">
				...
				<div class="contact_planet_full hidden" id="full">
					<div class="contact_full">
						...
						<div class="contact_full_left">
							...
							<div><a href="callto:+380676798999" style="text-decoration:none;">+380 (67) 67 98 999</a></div>
							<div><a href="callto:+380562680111" style="text-decoration:none;">+380 (562) 680 111 (<?php echo JText::_('CONTACT_FAX')?>)</a></div>
						</div>
						<div class="contact_full_right">
