...
<?php 
	...
	if ($menu->href == "option=com_content&view=frontpage&layout=about"){$href = "/about";}else{
		...
		<div class="visible_block">
			...
			<div class="visible">
				...
				<?php if (preg_match('/-portfolio-/', $menu->desc)) :?>
					<a href="javascript:void(0);" onclick="randomTeaser();" class="visible_corner visible_bottom_right_works_randomize">Следующая</a>
				<?php endif;?>
